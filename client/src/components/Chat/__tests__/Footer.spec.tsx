...
describe('Footer', () => {
  test('opens the default OpenChat repository link in a new tab', () => {
    render(<Footer startupConfig={null} />);
    const link = screen.getByRole('link', { name: /OpenChat/ });
    expect(link).toHaveAttribute('href', 'https://github.com/diegoluppi1993/openchat');
